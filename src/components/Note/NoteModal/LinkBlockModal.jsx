...
function LinkBlockModal ({activeLinkModal, handleClick, handleLink}) {
    ...
    return <div className={classModal} id="exampleModalToggle1" aria-labelledby="exampleModalToggleLabel2">
        <div className="modal-dialog modal-dialog-centered">
            <OutsideClickHandler onOutsideClick={() => {handleClick(false)}}>
            <form className="modal-content" onSubmit={handleSubmit(handleLink)}>
                <div className="modal-header">
                    <div className="btn_link"><b>Embed note</b></div>
                </div>
                <div className="modal-body">
                    <input {...register('name')} className="input_link--style"
                        type="text" size="40" placeholder="Name note"/>
                </div>
